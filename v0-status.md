...
| 0.6 | Patterns avancés : setup sequence-dependent, qualified operator, shared resources, calendars | 🟡 en cours | 2026-04-29 | — | Chaque pattern a ses tests unitaires golden | 0.6a ✅ (setup-dependent, 9 tests) · 0.6b ✅ (operator + shared, 10 tests) · 0.6c en cours (calendar + extension générateur) |
